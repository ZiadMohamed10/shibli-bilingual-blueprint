...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 w-full bg-background/85 dark:bg-background/80 backdrop-blur-lg border-b-2 border-primary/20 dark:border-primary/30 shadow-professional z-50">
